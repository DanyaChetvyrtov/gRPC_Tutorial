...
* Неплохой [видос](https://www.youtube.com/watch?v=_EqVG-El5z0&t=20s&ab_channel=MerionAcademy), где простым языком объясняется что это вообще такое. Также там рассказывают про разницу между JSON-RPC и gRPC.
## От автора
